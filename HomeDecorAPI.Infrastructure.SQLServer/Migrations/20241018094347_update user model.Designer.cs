...
namespace HomeDecorAPI.Infrastructure.SQLServer.Migrations
{
    ...
    [Migration("20241018094347_update user model")]
            ...
            modelBuilder.Entity("HomeDecorAPI.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 10, 18, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8725),
                            Description = "A sleek and modern coffee table made from high-quality oak wood.",
                            DiscountEndDate = new DateTime(2024, 11, 17, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8717),
                            DiscountPercentage = 10,
                            ImageUrl = "https://th.bing.com/th/id/OIP.j8duPDpTdbCRp96Z-V6jXQHaHa?rs=1&pid=ImgDetMain",
                            IsNewExpiryDate = new DateTime(2024, 11, 1, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8724),
                            Measurements = "120x60x45 cm",
                            Name = "Modern Wooden Coffee Table",
                            OriginalPrice = 149.99m,
                            SKU = "WDN-COFTBL-001",
                            StockQuantity = 50,
                            UpdatedDate = new DateTime(2024, 10, 18, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8725)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 10, 18, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8728),
                            ...
                            SKU = "LTHR-ARMCHR-002",
                            StockQuantity = 20,
                            UpdatedDate = new DateTime(2024, 10, 18, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8729)
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 10, 18, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8732),
                            Description = "A minimalist floor lamp with a sleek metal frame and adjustable height.",
                            DiscountEndDate = new DateTime(2024, 12, 2, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8731),
                            DiscountPercentage = 15,
                            ImageUrl = "https://i5.walmartimages.com/asr/3181df7b-b2e3-411e-bf47-95fe5bcd8c4b_1.c7553cfd9e1daaed9c6cd9e1544bb12b.jpeg",
                            IsNewExpiryDate = new DateTime(2024, 11, 1, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8731),
                            Measurements = "Height: 150-180 cm",
                            Name = "Contemporary Floor Lamp",
                            OriginalPrice = 89.99m,
                            SKU = "MTL-FLRLMP-003",
                            StockQuantity = 100,
                            UpdatedDate = new DateTime(2024, 10, 18, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8733)
                        },
                        new
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2024, 10, 18, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8735),
                            Description = "A beautiful vintage wall clock with a wooden frame and Roman numerals.",
                            DiscountEndDate = new DateTime(2024, 11, 2, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8735),
                            ...
                            SKU = "VTG-WLCLK-004",
                            StockQuantity = 75,
                            UpdatedDate = new DateTime(2024, 10, 18, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8736)
                        },
                        new
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2024, 10, 18, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8739),
                            Description = "A luxurious dining table with a polished marble top and sturdy metal legs.",
                            DiscountEndDate = new DateTime(2024, 12, 17, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8738),
                            DiscountPercentage = 20,
                            ImageUrl = "https://th.bing.com/th/id/R.8c5920f9aeefc029e47eb83afb6f5283?rik=ACMUfp1vINNgnQ&pid=ImgRaw&r=0",
                            IsNewExpiryDate = new DateTime(2024, 11, 1, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8738),
                            Measurements = "200x100x75 cm",
                            Name = "Marble Dining Table",
                            OriginalPrice = 799.99m,
                            SKU = "MRB-DNTBL-005",
                            StockQuantity = 10,
                            UpdatedDate = new DateTime(2024, 10, 18, 9, 43, 47, 68, DateTimeKind.Utc).AddTicks(8740)
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "89ef8be6-16fa-4643-8c6b-4ae6634a429e",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "4069941b-57f6-4cd8-9c72-2196162db3c2",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "0691197b-5974-4a32-aeb3-271a0204c87e",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "a179edda-0d0b-4fa2-b7a4-07cb03428697",
                            Name = "ContentCreator",
                            NormalizedName = "CONTENTCREATOR"
                        },
                        new
                        {
                            Id = "7d9bc656-a280-4f5d-a5b7-15c3c9fbb1c6",
                            Name = "Moderator",
