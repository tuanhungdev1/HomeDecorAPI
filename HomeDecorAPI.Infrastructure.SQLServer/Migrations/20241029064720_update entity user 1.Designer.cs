...
namespace HomeDecorAPI.Infrastructure.SQLServer.Migrations
{
    ...
    [Migration("20241029064720_update entity user 1")]
    partial class updateentityuser1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeDecorAPI.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 10, 29, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4136),
                            Description = "A sleek and modern coffee table made from high-quality oak wood.",
                            DiscountEndDate = new DateTime(2024, 11, 28, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4129),
                            DiscountPercentage = 10,
                            ImageUrl = "https://th.bing.com/th/id/OIP.j8duPDpTdbCRp96Z-V6jXQHaHa?rs=1&pid=ImgDetMain",
                            IsNewExpiryDate = new DateTime(2024, 11, 12, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4135),
                            Measurements = "120x60x45 cm",
                            Name = "Modern Wooden Coffee Table",
                            OriginalPrice = 149.99m,
                            SKU = "WDN-COFTBL-001",
                            StockQuantity = 50,
                            UpdatedDate = new DateTime(2024, 10, 29, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4137)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 10, 29, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4140),
                            ...
                            SKU = "LTHR-ARMCHR-002",
                            StockQuantity = 20,
                            UpdatedDate = new DateTime(2024, 10, 29, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4141)
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 10, 29, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4145),
                            Description = "A minimalist floor lamp with a sleek metal frame and adjustable height.",
                            DiscountEndDate = new DateTime(2024, 12, 13, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4143),
                            DiscountPercentage = 15,
                            ImageUrl = "https://i5.walmartimages.com/asr/3181df7b-b2e3-411e-bf47-95fe5bcd8c4b_1.c7553cfd9e1daaed9c6cd9e1544bb12b.jpeg",
                            IsNewExpiryDate = new DateTime(2024, 11, 12, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4144),
                            Measurements = "Height: 150-180 cm",
                            Name = "Contemporary Floor Lamp",
                            OriginalPrice = 89.99m,
                            SKU = "MTL-FLRLMP-003",
                            StockQuantity = 100,
                            UpdatedDate = new DateTime(2024, 10, 29, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4145)
                        },
                        new
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2024, 10, 29, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4148),
                            Description = "A beautiful vintage wall clock with a wooden frame and Roman numerals.",
                            DiscountEndDate = new DateTime(2024, 11, 13, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4147),
                            ...
                            SKU = "VTG-WLCLK-004",
                            StockQuantity = 75,
                            UpdatedDate = new DateTime(2024, 10, 29, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4149)
                        },
                        new
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2024, 10, 29, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4152),
                            Description = "A luxurious dining table with a polished marble top and sturdy metal legs.",
                            DiscountEndDate = new DateTime(2024, 12, 28, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4151),
                            DiscountPercentage = 20,
                            ImageUrl = "https://th.bing.com/th/id/R.8c5920f9aeefc029e47eb83afb6f5283?rik=ACMUfp1vINNgnQ&pid=ImgRaw&r=0",
                            IsNewExpiryDate = new DateTime(2024, 11, 12, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4152),
                            Measurements = "200x100x75 cm",
                            Name = "Marble Dining Table",
                            OriginalPrice = 799.99m,
                            SKU = "MRB-DNTBL-005",
                            StockQuantity = 10,
                            UpdatedDate = new DateTime(2024, 10, 29, 6, 47, 19, 526, DateTimeKind.Utc).AddTicks(4153)
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d27c1c7e-f2b3-448d-a9d4-548e94d853b4",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "384179f8-d39f-4d72-9ae0-616cf3e1bbf7",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "556bd86d-5201-4212-936f-de9987aace19",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "be95ba39-ed7b-4e69-80d9-e9fad7913f40",
                            Name = "ContentCreator",
                            NormalizedName = "CONTENTCREATOR"
                        },
                        new
                        {
                            Id = "37c62394-4336-48e2-8a30-89e2267c014b",
                            Name = "Moderator",
            ...
            modelBuilder.Entity("HomeDecorAPI.Domain.Entities.Product", b =>
                {
                    b.HasOne("HomeDecorAPI.Domain.Entities.Brand", null)
                        .WithMany("Products")
